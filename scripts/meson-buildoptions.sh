...
meson_options_help() {
  ...
  printf "%s\n" '                           upgrades'
  printf "%s\n" '  --enable-pas-expansion   expand the address space of the platform bus'
  ...
  printf "%s\n" '  --disable-ham-migration  disable ham migration'
  ...
  printf "%s\n" '  ub              unify bus support'
  printf "%s\n" '  ham-migration   live migration via memory semantics'
  printf "%s\n" '  urma-migration  live migration via urma protocol support'
