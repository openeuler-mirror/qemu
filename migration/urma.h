...
#define URMA_JETTY_WR_LIST_LEN 256
...
typedef struct URMALocalBlock {
    ...
    urma_seg_t           *remote_seg;      /* remote seg buffer from urma_get_seg_ctx */
    uint32_t             remote_seg_len;  /* length of remote seg buffer from urma_get_seg_ctx*/
...
typedef struct URMAContext {
    ...
    urma_jfs_wr_t jfs_wr_list[URMA_JETTY_WR_LIST_LEN];
    urma_sge_t src_sge[URMA_JETTY_WR_LIST_LEN];
    urma_sge_t dst_sge[URMA_JETTY_WR_LIST_LEN];
    int nr_wr_polling;
