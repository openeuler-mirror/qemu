...
void aa32_max_features(ARMCPU *cpu)
{
    ...
    FIELD_DP32_IDREG(isar, ID_MMFR5, ETS, 1);          /* FEAT_ETS */
...
static void cortex_m0_initfn(Object *obj)
{
     ...
     * for the M3.
     */
    SET_IDREG(&cpu->isar, ID_PFR0, 0x00000030);
    SET_IDREG(&cpu->isar, ID_PFR1, 0x00000200);
    SET_IDREG(&cpu->isar, ID_DFR0, 0x00100000);
    cpu->id_afr0 = 0x00000000;
    SET_IDREG(&cpu->isar, ID_MMFR0, 0x00000030);
    SET_IDREG(&cpu->isar, ID_MMFR1, 0x00000000);
    SET_IDREG(&cpu->isar, ID_MMFR2, 0x00000000);
    SET_IDREG(&cpu->isar, ID_MMFR3, 0x00000000);
...
static void cortex_m7_initfn(Object *obj)
{
    ...
    SET_IDREG(&cpu->isar, ID_DFR0, 0x00100000);
    cpu->id_afr0 = 0x00000000;
    SET_IDREG(&cpu->isar, ID_MMFR0, 0x00100030);
    SET_IDREG(&cpu->isar, ID_MMFR1, 0x00000000);
    SET_IDREG(&cpu->isar, ID_MMFR2, 0x01000000);
    SET_IDREG(&cpu->isar, ID_MMFR3, 0x00000000);
...
static void cortex_m33_initfn(Object *obj)
{
    ...
    cpu->isar.mvfr2 = 0x00000040;
    SET_IDREG(&cpu->isar, ID_PFR0, 0x00000030);
    SET_IDREG(&cpu->isar, ID_PFR1, 0x00000210);
    SET_IDREG(&cpu->isar, ID_DFR0, 0x00200000);
    cpu->id_afr0 = 0x00000000;
    SET_IDREG(&cpu->isar, ID_MMFR0, 0x00101F40);
    SET_IDREG(&cpu->isar, ID_MMFR1, 0x00000000);
    SET_IDREG(&cpu->isar, ID_MMFR2, 0x01000000);
    SET_IDREG(&cpu->isar, ID_MMFR3, 0x00000000);
    SET_IDREG(isar, ID_ISAR0, 0x01101110);
...
static void cortex_m55_initfn(Object *obj)
{
    ...
    cpu->isar.mvfr2 = 0x00000040;
    SET_IDREG(&cpu->isar, ID_PFR0, 0x20000030);
    SET_IDREG(&cpu->isar, ID_PFR1, 0x00000230);
    SET_IDREG(&cpu->isar, ID_DFR0, 0x10200000);
    cpu->id_afr0 = 0x00000000;
    SET_IDREG(&cpu->isar, ID_MMFR0, 0x00111040);
    SET_IDREG(&cpu->isar, ID_MMFR1, 0x00000000);
    SET_IDREG(&cpu->isar, ID_MMFR2, 0x01000000);
    SET_IDREG(&cpu->isar, ID_MMFR3, 0x00000011);
